function [x,mpcmilp, elapsed_time] = MPCMILPSimulationShrinkingHorizon(Nh, Np, T, Ppv_actual, Pwind_actual, HeatingD, Cg_Im, Cg_Ex, Grid, Batt, dt, Capacities, Hs, CO2, f, nvars, Ndays)
